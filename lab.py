...
# ---------------------------------------------------------
    ...
    with col_import:
        ...
        st.info("💡 Bạn có thể thả trực tiếp file báo cáo định lượng PDF của Agilent MassHunter vào đây.")
        
        gc_file = st.file_uploader("Kéo thả báo cáo kết quả GC (PDF/Excel/CSV)", type=["pdf", "xlsx", "csv"])
